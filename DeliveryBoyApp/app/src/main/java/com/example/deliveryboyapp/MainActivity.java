...
public class MainActivity extends AppCompatActivity {
    ...
    String apiUrl = "http://172.20.10.5/h_and_h-food-delivery-app/public/api/users/delivery?email=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewUser.setText("Name: "+sharedPreferences.getString("name", "") + "\n" + "Email: " +
        ...
        buttonSuccess.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                markOrderStatus("http://172.20.10.5/h_and_h-food-delivery-app/public/api/users/delivery/success?order_id=" + order_id,
                        "success");
            }
        });
        ...
        buttonFailed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                markOrderStatus("http://172.20.10.5/h_and_h-food-delivery-app/public/api/users/delivery/failed?order_id=" + order_id,
                        "failed");
            }
        });
