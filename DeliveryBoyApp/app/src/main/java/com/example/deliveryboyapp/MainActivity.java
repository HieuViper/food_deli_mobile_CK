...
public class MainActivity extends AppCompatActivity {
    ...
    String apiUrl = "http://192.168.2.24/h_and_h-food-delivery-app/public/api/users/delivery?email=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSuccess.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                markOrderStatus("http://192.168.2.24/h_and_h-food-delivery-app/public/api/users/delivery/success?order_id=" + order_id,
                        "success");
            }
        });
        ...
        buttonFailed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                markOrderStatus("http://192.168.2.24/h_and_h-food-delivery-app/public/api/users/delivery/failed?order_id=" + order_id,
                        "failed");
            }
        });
